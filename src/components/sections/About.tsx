      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-16 sm:mb-20">
          <div className="animate-fade-in-left">
            <h3 className="text-2xl sm:text-3xl font-bold text-foreground mb-3 sm:mb-4">Who We Are</h3>
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6 animate-fade-in-up-stagger" style={{ animationDelay: '0.6s' }}>
              <div className="text-center p-4 bg-card rounded-lg shadow-soft">
                <div className="text-xl sm:text-2xl font-bold text-primary mb-1">2023</div>
          ...
          <div className="animate-fade-in-right">
            <img 
              ...
              className="rounded-2xl shadow-strong w-full h-48 sm:h-64 object-cover mt-8 lg:mt-0"
            />
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 sm:gap-8 mt-12 sm:mt-16">
          {/* Mission */}
          <div className="animate-fade-in-up-stagger bg-card p-6 sm:p-8 rounded-2xl shadow-medium hover:shadow-strong transition-all duration-300" style={{ animationDelay: '0.8s' }}>
            <div className="flex items-center mb-4 sm:mb-6">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-primary rounded-full flex items-center justify-center mr-3 sm:mr-4">
          ...
          {/* Vision */}
          <div className="animate-fade-in-up-stagger bg-card p-6 sm:p-8 rounded-2xl shadow-medium hover:shadow-strong transition-all duration-300" style={{ animationDelay: '1.0s' }}>
            <div className="flex items-center mb-4 sm:mb-6">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-primary rounded-full flex items-center justify-center mr-3 sm:mr-4">
          ...
          {/* Core Values */}
          <div className="animate-fade-in-up-stagger bg-card p-6 sm:p-8 rounded-2xl shadow-medium hover:shadow-strong transition-all duration-300" style={{ animationDelay: '1.2s' }}>
            <div className="flex items-center mb-4 sm:mb-6">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-primary rounded-full flex items-center justify-center mr-3 sm:mr-4">
                <Heart className="h-5 w-5 sm:h-6 sm:w-6 text-primary-foreground" />
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-foreground">Core Values</h3>
            </div>
            <ul className="text-sm sm:text-base text-muted-foreground leading-relaxed list-disc list-inside space-y-1 sm:space-y-2">
        ...
        <div className="mt-16 sm:mt-20 text-center animate-fade-in-up">
          <h3 className="text-2xl sm:text-3xl font-bold text-foreground mb-8 sm:mb-12">Why Choose SolveSphere?</h3>
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            ...
            },
            {
              ...
              <div key={index} className="p-4 sm:p-6 animate-fade-in-up-stagger" style={{ animationDelay: `${1.4 + index * 0.2}s` }}>
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-primary rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <reason.icon className="h-7 w-7 sm:h-8 sm:w-8 text-primary-foreground" />
                </div>
                <h4 className="text-lg sm:text-xl font-semibold text-foreground mb-2 sm:mb-3">{reason.title}</h4>
