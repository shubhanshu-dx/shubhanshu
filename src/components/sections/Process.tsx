  ...
  return (
    <section id="process" className="py-20 bg-gradient-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {steps.map((step, index) => (
              <div key={index} className="group relative animate-fade-in-up-stagger" style={{ animationDelay: `${0.2 + index * 0.15}s` }}>
                ...
                {index < steps.length - 1 && (
                  <div className="lg:hidden flex justify-center mt-6 sm:mt-8 mb-6 sm:mb-8">
                    <ArrowRight className="h-7 w-7 sm:h-8 sm:w-8 text-primary animate-pulse" />
                  </div>
                )}
                
                <div className="relative bg-card p-6 sm:p-8 rounded-3xl shadow-medium group-hover:shadow-strong transition-all duration-500 group-hover:-translate-y-2">
                  {/* Step Number */}
                  <div className="absolute -top-4 left-6 sm:left-8 w-9 h-9 sm:w-10 sm:h-10 bg-gradient-primary rounded-full flex items-center justify-center text-primary-foreground font-bold text-base sm:text-lg border-2 border-background">
                    {index + 1}
                  </div>
                  
                  {/* Icon */}
                  <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-primary rounded-2xl flex items-center justify-center mb-4 sm:mb-6 mx-auto group-hover:animate-glow">
                    <step.icon className="h-8 w-8 sm:h-10 sm:w-10 text-primary-foreground" />
                  </div>
                  
                  {/* Content */}
                  <div className="text-center mb-4 sm:mb-6">
                    <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-1 sm:mb-2">{step.title}</h3>
                    <p className="text-primary font-semibold text-base sm:text-lg">{step.subtitle}</p>
                  </div>
        ...
        <div className="mt-16 sm:mt-20 text-center bg-gradient-section p-6 sm:p-8 md:p-12 rounded-3xl animate-fade-in-up">
          <h3 className="text-2xl sm:text-3xl font-bold text-foreground mb-3 sm:mb-4">Why Our Process Delivers Results</h3>
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            ...
            },
            {
              ...
              <div key={index} className="p-4 sm:p-6 animate-fade-in-up-stagger" style={{ animationDelay: `${0.8 + index * 0.15}s` }}>
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-primary rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <benefit.icon className="h-7 w-7 sm:h-8 sm:w-8 text-primary-foreground" />
                </div>
        ...
        {/* Call to Action */}
        <div className="mt-12 sm:mt-16 text-center animate-fade-in-up" style={{ animationDelay: `${0.8 + steps.length * 0.15}s` }}>
          <div className="bg-gradient-primary p-6 sm:p-8 rounded-3xl text-center animate-scale-in">
            ...
            <Button 
              ...
              className="bg-primary-foreground text-primary px-6 sm:px-8 py-2.5 sm:py-3 text-base sm:text-lg rounded-full font-semibold hover:shadow-lg transition-all duration-300 hover:scale-105"
            >
              Get Started Today
            </Button>
          </div>
